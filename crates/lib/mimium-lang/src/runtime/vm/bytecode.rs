...
impl std::fmt::Display for Instruction {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Instruction::VAddF(dst, lhs, rhs) => write!(f, "{:<10} {} {} {}", "vaddf", dst, lhs, rhs),
            Instruction::VSubF(dst, lhs, rhs) => write!(f, "{:<10} {} {} {}", "vsubf", dst, lhs, rhs),
            Instruction::VMulF(dst, lhs, rhs) => write!(f, "{:<10} {} {} {}", "vmulf", dst, lhs, rhs),
            Instruction::VDivF(dst, lhs, rhs) => write!(f, "{:<10} {} {} {}", "vdivf", dst, lhs, rhs),
