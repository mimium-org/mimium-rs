...
impl std::fmt::Display for Instruction {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        match self {
            ...
            Instruction::VAddF(a, b) => write!(f, "vaddf {} {}", *a, *b),
            Instruction::VSubF(a, b) => write!(f, "vsubf {} {}", *a, *b),
            Instruction::VMulF(a, b) => write!(f, "vmulf {} {}", *a, *b),
            Instruction::VDivF(a, b) => write!(f, "vdivf {} {}", *a, *b),
